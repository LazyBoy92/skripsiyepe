...
if ($_GET['post']=='hapus') {
    ...
    $file_lama=mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_file FROM file_materi WHERE id_file='$_GET[id_file]'"));
    $exist_file = 'module/files_materi/'.$file_lama['nama_file'];
    unlink($exist_file);

    mysqli_query($koneksi,"DELETE FROM file_materi_det WHERE id_file='$_GET[id_file]'");
    mysqli_query($koneksi,"DELETE FROM file_materi WHERE id_file='$_GET[id_file]'");
