...
<?php
  ...
  $jmldata     = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM file_video"));
  ...
  <div class="col-lg-4 mt-4">
    <div class="card shadow">
      ...
      <div class="card-footer">
        <a href="?module=f_video&act=lihat&id=<?=$r['id_video'];?>" class="btn-sm btn-primary"> View</a>
        <a href="#" data-toggle="modal" data-target="#edit_<?=$r['id_video'];?>" class="btn-sm btn-warning"> Edit</a>
        <a href="javascript:confirmdelete('?module=f_video&act=save&post=hapus&id_video=<?php echo $r['id_video'];?>')" class="btn-sm btn-danger"><i class="fas fa-trash"></i></a>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="edit_<?php echo $r['id_video'];?>"  role="dialog" >
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <form action="?module=f_video&act=save" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <form action="?module=f_video&act=save" method="POST" role="form" enctype="multipart/form-data">
        ...
        <?php 
          ...
          $sq_mpl=mysqli_query($koneksi,"SELECT nama_mapel, id_mapel FROM m_mapel ORDER BY id_mapel ASC");
        ?>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form action="?module=f_video&act=save" method="POST" role="form" enctype="multipart/form-data">
        ...
        <?php 
          ...
          $sq_mpl=mysqli_query($koneksi,"SELECT nama_mapel,id_mapel FROM m_mapel ");
        ?>
          <div class="form-group">
              <label for="">Judul Video</label>
                <input type="hidden" class="form-control" name="pembuat" value="<?= $_SESSION['id_user'];?>">
