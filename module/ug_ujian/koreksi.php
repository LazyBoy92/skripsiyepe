...
header('location:../index.php');
      ...
      $sql_data=mysqli_query($koneksi,"SELECT DISTINCT a.pertanyaan,a.id_soal,a.gambar,b.jawaban_esay,b.nilai,b.id_nesay  FROM soal_esay a, nilai_esay b WHERE a.id_soal=b.id_soalesay AND b.id_ujian='$id_ujian' AND b.id_siswa='$id_siswa'");
      $qbt = mysqli_fetch_array(mysqli_query($koneksi,"SELECT COUNT(id_soal) as jum_soal FROM soal_esay WHERE id_tujian='$id_ujian'"));
      $xb   = round(100/$qbt['jum_soal']);
      //echo "SELECT COUNT(id_soal) as jum_soal FROM soal_esay WHERE id_tujian='$id_ujian'";
      ...
      <div class="col-md-8">
            <div class="card shadow">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Jawaban Siswa</b></h6>
                        <div class="dropdown no-arrow">
                              <a href="?module=ug_ujian&act=detail_peserta&id=<?=$id_ujian;?>" class="btn-sm btn-warning"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
                        </div>
                  </div>
                  <div class="card-body">
                              ...
                              <table class="table table-bordered table-striped" id="table_1"  width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody>
                                          ...
                                          <tr>
                                                ...
                                                <td align="center"><a href="#" class="btn-sm btn-warning" data-toggle="modal" data-target="#koreksi_<?= $row['id_nesay'];?>"><i class="fas fa-chalkboard-teacher"></i></a></td>
                                              ...
                                              <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                      ...
                                                      <form method="POST" action="?module=ug_ujian&act=save" enctype="multipart/form-data">
