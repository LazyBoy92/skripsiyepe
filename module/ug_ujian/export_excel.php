<head>
<!-- <link href="module/ug_ujian/style.css" rel="stylesheet" type="text/css" /> -->
<style>
    @page { size: A4 }
...
<body class="sheet" font-size="12pt">
	...
	header("Content-Disposition: attachment; filename=hasil_ujian_".$_POST['id_ujian']."_".$_POST['id_kelas']."_export.xls");
	...
	$sql_data=mysqli_query($koneksi,"SELECT a.nama_lengkap,a.id,b.id_kelas FROM siswa a, f_kelas b WHERE a.nis=b.nis AND b.id_kelas='$id_kelas' AND b.tp='$tahun_p'");
