<?php
  ...
  $user_2= mysqli_fetch_array(mysqli_query($koneksi,"SELECT foto FROM siswa WHERE id='$id_siswa'"));
    ...
    $dari_2= mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_lengkap,foto FROM siswa WHERE id='$id_siswa'"));
    $nama_lengkap=$dari_2['nama_lengkap'].' <i class="text-info">==Siswa==</i>';

	}else{
	
    $dir2="module/foto_pengajar";
    $dari_2 = mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_lengkap,foto FROM guru WHERE id='$id_siswa'"));
    	...
    	<div class="card shadow" >
      	...
      	<div class="card-footer">
						...
						<div class="form-group">
							...
							<div class="row">
                <input type="text" name="pesan" id="pesan" class="form-control ml-3 mt-2" style="width: 770px;"> &nbsp;
								
                <div class="tomUpload btn btn-info"><i class="fas fa-paperclip"></i><input class="upload" type="file" name="file" id="file" value=""></div>&nbsp;
